...
-- -----------------------------------------------------
-- Table `P6_DB`.`Connexion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`Connexion` ;
...
-- Table `P6_DB`.`Account`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`Account` ;
...
-- -----------------------------------------------------
-- Table `P6_DB`.`External_account`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`External_account` ;
...
-- -----------------------------------------------------
-- Table `P6_DB`.`External_movements`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`External_movements` ;
...
-- -----------------------------------------------------
-- Table `P6_DB`.`Movements`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`Movements` ;

CREATE TABLE IF NOT EXISTS `P6_DB`.`Movements` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `P6_DB`.`Fees`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `P6_DB`.`Fees` ;
